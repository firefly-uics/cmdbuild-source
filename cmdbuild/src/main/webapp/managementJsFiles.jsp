...
<!-- VIEWS -->
	...
	<script type="text/javascript" src="javascripts/cmdbuild/view/management/common/CMCardForm.js"></script>
		...
		<script type="text/javascript" src="javascripts/cmdbuild/view/management/common/widgets/manageEmail/MainPanel.js"></script>
 		<script type="text/javascript" src="javascripts/cmdbuild/view/management/common/widgets/manageEmail/CMDMSAttachmentPicker.js"></script>
...
<!-- CONTROLLER -->
	...
	<script type="text/javascript" src="javascripts/cmdbuild/controller/management/common/CMCardBrowserTreeDataSource.js"></script>
		...
		<script type="text/javascript" src="javascripts/cmdbuild/controller/management/common/widgets/manageEmail/Main.js"></script>
