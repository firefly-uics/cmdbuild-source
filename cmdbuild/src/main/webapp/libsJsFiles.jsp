...
<!-- Portal -->
<script type="text/javascript" src="javascripts/ext-<%= extVersion %>-ux/portal/Portlet.js"></script>
<script type="text/javascript" src="javascripts/ext-<%= extVersion %>-ux/portal/PortalDropZone.js"></script>
