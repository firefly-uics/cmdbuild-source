...
if (params.rayPick) {
	...
	var rayPickBuf = states.rayPickBuf;
	// Lazy-create Z-pick buffer
	if (!rayPickBuf) {
		rayPickBuf = states.rayPickBuf = new SceneJS_PickBuffer({
	...
	pickResult.canvasPos = [canvasX, canvasY];
	pickResult.worldPos = vWorld;
}
