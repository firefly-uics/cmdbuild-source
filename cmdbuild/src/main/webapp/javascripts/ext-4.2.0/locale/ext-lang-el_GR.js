...
(function () {
	...
	Ext.define('Ext.locale.el_GR.picker.Month', {
		override: 'Ext.picker.Month',

		okText: '<em>&#160;OK&#160;</em>',
		cancelText: '<em>Cancel</em>'
	});
	...
	Ext.define('Ext.locale.el_GR.form.Basic', {
		override: 'Ext.form.Basic',

		waitTitle: '<em>Please Wait...</em>'
	});
	...
	Ext.define('Ext.locale.el_GR.grid.BooleanColumn', {
	...
	Ext.define('Ext.locale.el_GR.grid.NumberColumn', {
		override: 'Ext.grid.NumberColumn',

		format: '0,000.00'
	});

	Ext.define('Ext.locale.el_GR.grid.DateColumn', {
		override: 'Ext.grid.DateColumn',

		format: 'd/m/Y'
	});

	Ext.define('Ext.locale.el_GR.form.field.Time', {
		override: 'Ext.form.field.Time',

		minText: '<em>The time in this field must be equal to or after {0}</em>',
		maxText: '<em>The time in this field must be equal to or before {0}</em>',
		invalidText: '<em>{0} is not a valid time</em>',
		format: 'g:i A',
		altFormats: 'g:ia|g:iA|g:i a|g:i A|h:i|g:i|H:i|ga|ha|gA|h a|g a|g A|gi|hi|gia|hia|g|H'
	});

	Ext.define('Ext.locale.el_GR.form.CheckboxGroup', {
		override: 'Ext.form.CheckboxGroup',

		blankText: '<em>You must select at least one item in this group</em>'
	});

	Ext.define('Ext.locale.el_GR.form.RadioGroup', {
		override: 'Ext.form.RadioGroup',

		blankText: '<em>You must select one item in this group</em>'
	});
