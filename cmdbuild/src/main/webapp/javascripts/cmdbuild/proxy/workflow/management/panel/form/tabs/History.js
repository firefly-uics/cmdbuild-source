(function () {
	...
	Ext.define('CMDBuild.proxy.workflow.management.panel.form.tabs.History', {

		requires: [
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.proxy.index.Json',
			'CMDBuild.model.workflow.management.panel.form.tabs.history.CardRecord'
		],
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.HISTORY, {
				autoLoad: false,
				model: 'CMDBuild.model.workflow.management.panel.form.tabs.history.CardRecord',
				proxy: {
					type: 'ajax',
