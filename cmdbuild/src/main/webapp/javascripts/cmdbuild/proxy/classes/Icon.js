(function () {
	...
	Ext.define('CMDBuild.proxy.classes.Icon', {
		...
		getFolders: function (parameters) {
			...
			Ext.apply(parameters, {
				method: 'GET',
				url: CMDBuild.proxy.index.Rest.fileStores + '/images/folders/'
			});
		...
		remove: function (parameters) {
			...
			CMDBuild.core.interfaces.Rest.request({
				method: 'DELETE',
				url: CMDBuild.proxy.index.Rest.icons + '/' + parameters.urlParams['iconId'],
				...
				success: function (response, options, decodedResponse) {
					...
					Ext.apply(parameters, {
						method: 'DELETE',
						url: CMDBuild.proxy.index.Rest.fileStores + '/folders/'
