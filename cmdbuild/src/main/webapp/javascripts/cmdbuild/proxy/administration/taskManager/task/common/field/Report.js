(function () {
	...
	Ext.define('CMDBuild.proxy.administration.taskManager.task.common.field.Report', {

		requires: [
			'CMDBuild.core.configurations.Timeout',
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.core.constants.Server',
			'CMDBuild.model.administration.taskManager.task.common.field.report.Report',
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.REPORT, {
				autoLoad: true,
				model: 'CMDBuild.model.administration.taskManager.task.common.field.report.Report',
				proxy: {
					type: 'ajax',
