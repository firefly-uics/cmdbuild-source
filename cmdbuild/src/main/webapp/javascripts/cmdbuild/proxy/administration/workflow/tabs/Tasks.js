(function () {
	...
	Ext.define('CMDBuild.proxy.administration.workflow.tabs.Tasks', {

		requires: [
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.proxy.index.Json',
			'CMDBuild.model.administration.workflow.tabs.taskManager.Grid'
		],
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.TASK, {
				autoLoad: false,
				model: 'CMDBuild.model.administration.workflow.tabs.taskManager.Grid',
				proxy: {
					type: 'ajax',
