(function () {
	...
	Ext.define('CMDBuild.proxy.administration.configuration.Dms', {

		requires: [
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.proxy.index.Json',
			'CMDBuild.model.administration.configuration.dms.Lookup'
		],
		...
		getStoreLookups: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.LOOKUP, {
				autoLoad: true,
				model: 'CMDBuild.model.administration.configuration.dms.Lookup',
				proxy: {
					type: 'ajax',
