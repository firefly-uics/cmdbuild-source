(function () {
	...
	Ext.define('CMDBuild.proxy.taskManager.task.Connector', {

		requires: [
			'CMDBuild.core.constants.Global',
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.proxy.index.Json',
			'CMDBuild.model.taskManager.task.connector.AvailableSqlSources',
			'CMDBuild.model.taskManager.task.connector.Class',
		...
		getStoreClasses: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.CLASS, {
				autoLoad: true,
				model: 'CMDBuild.model.taskManager.task.connector.Class',
				proxy: {
					type: 'ajax',
		...
		getStoreDbTypes: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.TASK_MANAGER, {
				autoLoad: true,
				model: 'CMDBuild.model.taskManager.task.connector.AvailableSqlSources',
				proxy: {
					type: 'ajax',
