(function () {
	...
	Ext.define('CMDBuild.proxy.taskManager.task.common.ReportForm', {

		requires: [
			'CMDBuild.core.configurations.Timeout',
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.core.constants.Server',
			'CMDBuild.model.taskManager.task.common.reportForm.Report',
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.REPORT, {
				autoLoad: true,
				model: 'CMDBuild.model.taskManager.task.common.reportForm.Report',
				proxy: {
					type: 'ajax',
