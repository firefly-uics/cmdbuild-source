(function () {
	...
	Ext.define('CMDBuild.proxy.taskManager.task.Email', {

		requires: [
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.model.taskManager.Grid',
			'CMDBuild.model.taskManager.task.email.Account',
			'CMDBuild.model.taskManager.task.email.Lookup',
		...
		getStoreAccount: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.EMAIL, {
				autoLoad: false,
				model: 'CMDBuild.model.taskManager.task.email.Account',
				proxy: {
					type: 'ajax',
		...
		getStoreLokup: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.LOOKUP, {
				autoLoad: false,
				model: 'CMDBuild.model.taskManager.task.email.Lookup',
				proxy: {
					type: 'ajax',
