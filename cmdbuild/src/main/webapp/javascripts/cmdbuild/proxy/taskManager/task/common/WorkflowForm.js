(function () {
	...
	Ext.define('CMDBuild.proxy.taskManager.task.common.WorkflowForm', {

		requires: [
			'CMDBuild.core.constants.Global',
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.proxy.index.Json',
			'CMDBuild.model.taskManager.task.common.workflowForm.Workflow'
		],
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.WORKFLOW, {
				autoLoad: true,
				model: 'CMDBuild.model.taskManager.task.common.workflowForm.Workflow',
				proxy: {
					type: 'ajax',
