(function () {
	...
	Ext.define('CMDBuild.proxy.common.field.filter.advanced.configurator.tabs.Relations', {

		requires: [
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.DestinationEditorStore',
			'CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.DomainGrid'
		],
		...
		getStoreDestination: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.CLASS, {
				autoLoad: true,
				model: 'CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.DestinationEditorStore',
				proxy: {
					type: 'ajax',
		...
		getStoreDomain: function () {
			return Ext.create('Ext.data.ArrayStore', {
				model: 'CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.DomainGrid',
				data: [],
