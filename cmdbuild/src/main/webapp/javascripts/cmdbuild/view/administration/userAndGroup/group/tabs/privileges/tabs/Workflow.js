(function () {
	...
	Ext.define('CMDBuild.view.administration.userAndGroup.group.tabs.privileges.tabs.Workflow', {
		...
		/**
		 * @cfg {CMDBuild.controller.administration.userAndGroup.group.tabs.privileges.tabs.Workflow}
		 */
		delegate: undefined,
