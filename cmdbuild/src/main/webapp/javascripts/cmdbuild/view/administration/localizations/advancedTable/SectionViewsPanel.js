(function() {
	...
	Ext.define('CMDBuild.view.administration.localizations.advancedTable.SectionViewsPanel', {
		extend: 'Ext.panel.Panel',

		requires: ['CMDBuild.model.localizations.advancedTable.TreeStore'],

		/**
		 * @cfg {CMDBuild.controller.administration.localizations.advancedTable.SectionViews}
		 */
		delegate: undefined,
		...
		listeners: {
			show: function(panel, eOpts) {
				this.delegate.cmfg('onAdvancedTableViewsShow');
			}
		}
	});
