(function() {
	...
	Ext.define('CMDBuild.view.administration.tasks.event.asynchronous.CMStep2Delegate', {
		...
		/**
		 * @property {CMDBuild.view.administration.tasks.event.asynchronous.CMStep2}
		 */
		view: undefined,
				...
				_CMCache.getAttributeList(
					...
					function(attributes) {
						...
						if (!Ext.isEmpty(me.filterValues)) {
							if (!Ext.isEmpty(me.view.filterAttributeTab) && !Ext.isEmpty(me.filterValues[CMDBuild.core.proxy.Constants.ATTRIBUTE]))
								me.view.filterAttributeTab.setData(me.filterValues[CMDBuild.core.proxy.Constants.ATTRIBUTE]);

							if (!Ext.isEmpty(me.view.filterRelationTab) && !Ext.isEmpty(me.filterValues[CMDBuild.core.proxy.Constants.RELATION]))
								me.view.filterRelationTab.setData(me.filterValues[CMDBuild.core.proxy.Constants.RELATION]);
						}
		...
		getDataFilters: function() {
			if (
				...
				returnArray[CMDBuild.core.proxy.Constants.ATTRIBUTE] = this.view.filterAttributeTab.getData();
				returnArray[CMDBuild.core.proxy.Constants.RELATION] = this.view.filterRelationTab.getData();
