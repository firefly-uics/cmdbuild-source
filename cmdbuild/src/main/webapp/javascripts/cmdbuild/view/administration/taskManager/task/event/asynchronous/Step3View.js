(function () {
	...
	Ext.define('CMDBuild.view.administration.taskManager.task.event.asynchronous.Step3View', {
		extend: 'Ext.panel.Panel',

		requires: ['CMDBuild.core.constants.Proxy'],

		/**
		 * @cfg {CMDBuild.controller.administration.taskManager.task.event.asynchronous.Step3}
		 */
		delegate: undefined,
		...
		listeners: {
			show: function (view, eOpts) {
				this.delegate.cmfg('onTaskManagerFormTaskEventAsynchronousStep3Show');
			}
		}
	});
