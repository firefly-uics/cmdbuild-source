(function () {
	...
	Ext.define('CMDBuild.view.administration.classes.tabs.widgets.form.WorkflowPanel', {
		...
		/**
		 * @cfg {CMDBuild.controller.administration.classes.tabs.widgets.form.Workflow}
		 */
		delegate: undefined,
			...
			return Ext.Array.push(this.callParent(arguments), [
				Ext.create('Ext.form.field.ComboBox', {
					...
					listeners: {
						scope: this,
						change: function (combo, newValue, oldValue, eOpts) {
							this.delegate.cmfg('onClassesTabWidgetsWidgetWorkflowFilterTypeChange', newValue);
						}
					}
				})
			]);
