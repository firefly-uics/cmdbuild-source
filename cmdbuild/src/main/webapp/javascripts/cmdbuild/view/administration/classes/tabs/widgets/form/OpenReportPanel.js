(function () {
	...
	Ext.define('CMDBuild.view.administration.classes.tabs.widgets.form.OpenReportPanel', {
		...
		/**
		 * @cfg {CMDBuild.controller.administration.classes.tabs.widgets.form.OpenReport}
		 */
		delegate: undefined,
						...
						this.reportCode = Ext.create('Ext.form.field.ComboBox', {
							...
							listeners: {
								...
								select: function (combo, records, eOpts) {
									this.delegate.cmfg('onClassesTabWidgetsWidgetOpenReportReportSelect', { selectedReport: records[0] });
								}
							}
						}),
