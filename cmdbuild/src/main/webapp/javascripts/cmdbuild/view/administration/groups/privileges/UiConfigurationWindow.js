(function() {
	...
	Ext.define('CMDBuild.view.administration.groups.privileges.UiConfigurationWindow', {
		extend: 'CMDBuild.core.PopupWindow',

		requires: ['CMDBuild.core.proxy.CMProxyConstants'],

		/**
		 * @cfg {CMDBuild.controller.administration.groups.privileges.UiConfiguration}
		 */
		delegate: undefined,
