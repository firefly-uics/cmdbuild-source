(function() {
	...
	Ext.define('CMDBuild.view.administration.configuration.GuiFrameworkPanel', {
		...
		initComponent: function() {
			...
			this.externalCheckBox = Ext.create('Ext.ux.form.XCheckbox', {
				name: "guiFrameworkUrl",
				fieldLabel: "@@ External"//CMDBuild.Translation.enabled
			});
				...
				items: [
					Ext.create('Ext.form.FieldSet', {
						...
						items: [
								...
								this.externalCheckBox,
								{
									fieldLabel: "@@ core url",
									name: 'guiFrameworkCore',
									allowBlank: false,
									maxWidth: CMDBuild.CFG_BIG_FIELD_WIDTH
								},
								{
									fieldLabel: "@@ configuration url",
									name: 'guiFrameworkConfiguration',
									allowBlank: false,
									maxWidth: CMDBuild.CFG_BIG_FIELD_WIDTH
								}
							]
