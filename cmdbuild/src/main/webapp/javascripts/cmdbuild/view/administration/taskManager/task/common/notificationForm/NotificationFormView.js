(function () {
	...
	Ext.define('CMDBuild.view.administration.taskManager.task.common.notificationForm.NotificationFormView', {
		...
		constructor: function (configuration) {
			this.delegate = Ext.create('CMDBuild.controller.administration.taskManager.task.common.NotificationForm', this);
					...
					switch (itemConfig.type) {
						case 'sender': {
							if (!itemConfig.disabled)
								inputField = Ext.create('CMDBuild.view.administration.taskManager.task.common.notificationForm.SenderCombo', itemConfig);
						} break;

						case 'template': {
							if (!itemConfig.disabled)
								inputField = Ext.create('CMDBuild.view.administration.taskManager.task.common.notificationForm.TemplateCombo', itemConfig);
						} break;
					}
