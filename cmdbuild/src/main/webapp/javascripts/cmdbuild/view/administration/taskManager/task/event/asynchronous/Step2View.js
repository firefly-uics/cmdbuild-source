(function () {
	...
	Ext.define('CMDBuild.view.administration.taskManager.task.event.asynchronous.Step2View', {
		extend: 'Ext.panel.Panel',

		requires: ['CMDBuild.core.constants.Proxy'],

		/**
		 * @cfg {CMDBuild.controller.administration.taskManager.task.event.asynchronous.Step2}
		 */
		delegate: undefined,
