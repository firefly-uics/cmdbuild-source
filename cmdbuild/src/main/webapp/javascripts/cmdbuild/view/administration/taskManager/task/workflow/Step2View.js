(function () {
	...
	Ext.define('CMDBuild.view.administration.taskManager.task.workflow.Step2View', {
		extend: 'Ext.panel.Panel',

		requires: ['CMDBuild.core.constants.Proxy'],

		/**
		 * @cfg {CMDBuild.controller.administration.taskManager.task.workflow.Step2}
		 */
		delegate: undefined,
		...
		listeners: {
			show: function (view, eOpts) {
				this.delegate.cmfg('onTaskManagerFormTaskWorkflowStep2Show');
			}
		}
	});
