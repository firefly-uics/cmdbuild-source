(function () {
	...
	Ext.define('CMDBuild.view.administration.taskManager.task.email.Step2View', {
		extend: 'Ext.panel.Panel',

		requires: ['CMDBuild.core.constants.Proxy'],

		/**
		 * @cfg {CMDBuild.controller.administration.taskManager.task.email.Step2}
		 */
		delegate: undefined,
		...
		listeners: {
			show: function (view, eOpts) {
				this.delegate.cmfg('onTaskManagerFormTaskEmailStep2Show');
			}
		}
	});
