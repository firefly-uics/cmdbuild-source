(function() {
	...
	Ext.define('CMDBuild.view.administration.tasks.connector.CMStep2Delegate', {
	...
	Ext.define('CMDBuild.view.administration.tasks.connector.CMStep2', {
		...
		initComponent: function() {
			this.delegate = Ext.create('CMDBuild.view.administration.tasks.connector.CMStep2Delegate', this);
