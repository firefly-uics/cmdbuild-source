(function () {
	...
	Ext.define('CMDBuild.view.administration.classes.tabs.widgets.form.CalendarPanel', {
		...
		/**
		 * @cfg {CMDBuild.controller.administration.classes.tabs.widgets.form.Calendar}
		 */
		delegate: undefined,
						...
						Ext.create('Ext.form.field.ComboBox', {
							...
							listeners: {
								...
								change: function (combo, newValue, oldValue, eOpts) {
									this.delegate.cmfg('onClassesTabWidgetsWidgetCalendarTargetClassChange', newValue);
								}
							}
						}),
