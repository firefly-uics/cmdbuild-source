(function() {
	...
	Ext.define('CMDBuild.view.administration.localizations.advancedTable.SectionReportsPanel', {
		extend: 'Ext.panel.Panel',

		requires: ['CMDBuild.model.localizations.advancedTable.TreeStore'],

		/**
		 * @cfg {CMDBuild.controller.administration.localizations.advancedTable.SectionReports}
		 */
		delegate: undefined,
		...
		listeners: {
			show: function(panel, eOpts) {
				this.delegate.cmfg('onAdvancedTableReportsShow');
			}
		}
	});
