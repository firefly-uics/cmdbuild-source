(function() {
	...
	Ext.define('CMDBuild.view.management.classes.map.geoextension.Layer', {
		constructor : function(classId, geoAttribute, withEditWindow, interactionDocument) {
			this.interactionDocument = interactionDocument;
			this.layer = oPrivate.buildGeoserverLayer(geoAttribute);
	...
	var oPrivate = {
			buildGeoserverLayer : function(geoAttribute) {
