(function() {
	...
	Ext.define("CMDBuild.view.management.common.widgets.manageRelation.CMCardRelationsPanel", {
		...
		buildTBar: function() {
			...
			this.addRelationButton = Ext.create('CMDBuild.view.management.common.widgets.manageRelation.AddRelationMenuButton', {
