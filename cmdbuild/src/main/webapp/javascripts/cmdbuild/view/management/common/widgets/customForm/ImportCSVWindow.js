(function() {
	...
	Ext.define('CMDBuild.view.management.common.widgets.customForm.ImportCSVWindow', {
		...
		/**
		 * @cfg {CMDBuild.controller.management.common.widgets.customForm.ImportCSV}
		 */
		delegate: undefined,
						...
						items: [
							Ext.create('CMDBuild.core.buttons.Upload', {
								...
								handler: function(button, e) {
									this.delegate.cmfg('onCustomFormImportCSVUploadButtonClick');
								}
							}),
							Ext.create('CMDBuild.core.buttons.Abort', {
								...
								handler: function(button, e) {
									this.delegate.cmfg('onCustomFormImportCSVAbortButtonClick');
								}
							})
						]
					})
