(function() {
	 ...
	 */
	Ext.define("CMDBuild.view.management.widget.linkCards.map.CMMiniCardGrid", {
		...
		constructor: function() {
			this.mixins.delegable.constructor.call(this, "CMDBuild.view.management.widget.linkCards.map.CMMiniCardGridDelegate");
	...
	function deselectSilently(me) {
		try {
			...
			_error("ERROR deselecting the mini card grid", this, e);
		}
	}
