(function () {
	 ...
	 */
	Ext.define('CMDBuild.view.management.widget.linkCards.map.CMMiniCardGridDelegate', {
		...
		/**
		 * @param {CMDBuild.view.management.widget.linkCards.map.CMMiniCardGridDelegate} grid This grid
		 */
