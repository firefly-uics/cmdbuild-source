	...
	Ext.define('CMDBuild.view.management.widget.linkCards.LinkCards', {
		...
		initComponent: function () {
			...
			Ext.apply(this, {
				...
				items: [
					this.grid = Ext.create('CMDBuild.view.management.widget.linkCards.LinkCardsGrid', {
						autoScroll: true,
						selModel: this.getSelectionModel(),
						hideMode: 'offsets',
						border: false
					}),
					this.gisMapEnabled ? this.mapPanel = Ext.create('CMDBuild.view.management.widget.linkCards.map.CMMapPanel', {
						frame: false,
						border: false,
		...
		// Map methods
			/**
			 * @returns {CMDBuild.view.management.widget.linkCards.map.CMMapPanel}
			 */
