(function() {
	...
	Ext.define("CMDBuild.view.management.widget.linkCards.map.CMMiniCardGridWindow", {
		...
		constructor: function() {
			this.mixins.delegable.constructor.call(this, "CMDBuild.view.management.widget.linkCards.map.CMMiniCardGridWindowDelegate");
				...
				if (me.detailsPanel) {
					...
					for (var i=0, a=null, detail=null; i<attributes.length; ++i) {
						...
						if (detail) {
							...
							html += Ext.String.format('<li><span class="cm-bold">{0}:</span> {1}</li>', a.name, detail);
						}
					}
