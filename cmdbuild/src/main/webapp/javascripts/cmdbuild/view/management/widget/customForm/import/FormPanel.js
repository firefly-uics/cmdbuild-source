			...
			Ext.apply(this, {
				items: [
					Ext.create('Ext.form.field.ComboBox', { // Prepared for future implementations
						...
						store: CMDBuild.core.proxy.customForm.Csv.getStoreImportFileFormat(),
						queryMode: 'local'
					}),
					...
					Ext.create('Ext.form.field.ComboBox', {
						...
						store: CMDBuild.core.proxy.customForm.Csv.getStoreSeparator(),
						queryMode: 'local'
					}),
					this.modeCombo = Ext.create('Ext.form.field.ComboBox', {
						...
						store: CMDBuild.core.proxy.customForm.Csv.getStoreImportMode(
