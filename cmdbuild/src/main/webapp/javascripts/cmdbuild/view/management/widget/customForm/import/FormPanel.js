			...
			Ext.apply(this, {
				items: [
					Ext.create('Ext.form.field.ComboBox', { // Prepared for future implementations
						...
						store: CMDBuild.proxy.management.widget.customForm.Csv.getStoreImportFileFormat(),
						queryMode: 'local'
					}),
					...
					Ext.create('Ext.form.field.ComboBox', {
						...
						store: CMDBuild.proxy.management.widget.customForm.Csv.getStoreSeparator(),
						queryMode: 'local'
					}),
					this.modeCombo = Ext.create('Ext.form.field.ComboBox', {
						...
						store: CMDBuild.proxy.management.widget.customForm.Csv.getStoreImportMode(
