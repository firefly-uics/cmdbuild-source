...
//		cmAdvancedFilter: false, // to add a button to set an advanced filter
		...
		constructor: function (c) {
			this.mixins.delegable.constructor.call(this, "CMDBuild.view.management.workflow.panel.tree.filter.advanced.filterEditor.relations.CardGridPanelDelegate");
...
//		}
		...
		me.pagingBar = new CMDBuild.view.management.workflow.panel.tree.filter.advanced.filterEditor.relations.CMCardGridPagingBar({
			grid: me,
			store: me.store,
			displayInfo: true,
