(function() {
	Ext.define("CMDBuild.view.management.widget.linkCards.cardWindow.CMWidgetButton", {
...
Ext.define("CMDBuild.view.management.widget.linkCards.cardWindow.CMWidgetButtonsPanel", {
	...
	addWidget: function addWidget(widget) {
		...
		me.add(Ext.create('CMDBuild.view.management.widget.linkCards.cardWindow.CMWidgetButton', {
...
Ext.define("CMDBuild.view.management.widget.linkCards.cardWindow.CMWidgetButtonsPanelPopup", {
	extend: "CMDBuild.view.management.widget.linkCards.cardWindow.CMWidgetButtonsPanel",
	addWidget: function addWidget(widget) {
		var me = this;
		if (me._hidden) {
			me.show();
