(function () {
	...
	Ext.define("CMDBuild.view.common.entryTypeGrid.filter.advanced.filterEditor.relations.CMCardGridPagingBar", {
	...
	Ext.define("CMDBuild.view.common.entryTypeGrid.filter.advanced.filterEditor.relations.CardGridPanel", {
		...
		/**
		 * @cfg {CMDBuild.controller.common.entryTypeGrid.filter.advanced.filterEditor.relations.GridCard}
		 */
		delegate: undefined,
...
//		cmAdvancedFilter: false, // to add a button to set an advanced filter
		...
		constructor: function (c) {
			this.mixins.delegable.constructor.call(this, "CMDBuild.view.common.entryTypeGrid.filter.advanced.filterEditor.relations.CardGridPanelDelegate");
		...
		initComponent: function () {
			...
			this.mon(this, 'show', function (panel, record) {
				this.delegate.cmfg('onEntryTypeGridFilterAdvancedFilterEditorRelationsGridCardViewShow');
			}, this);
		},
...
//		}
		...
		me.pagingBar = new CMDBuild.view.common.entryTypeGrid.filter.advanced.filterEditor.relations.CMCardGridPagingBar({
			grid: me,
			store: me.store,
			displayInfo: true,
