(function () {
	 ...
	 * @adapter
	 */
	Ext.define('CMDBuild.view.common.field.filter.advanced.configurator.tabs.attributes.FieldSet', {
		...
		onFilterAttributeConditionPanelRemoveButtonClick: function (condition) {
			...
			if (count > 0) {
				...
				this.delegate.cmfg('fieldFilterAdvancedConfiguratorConfigurationAttributesFieldSetEmptied', this.attributeName);
			}
		}
	});
