(function () {
	...
	Ext.define('CMDBuild.view.common.field.filter.advanced.configurator.tabs.relations.DomainGridPanel', {
		...
		/**
		 * @cfg {CMDBuild.controller.common.field.filter.advanced.configurator.tabs.relations.GridDomain}
		 */
		delegate: undefined,
		...
		initComponent: function () {
			Ext.apply(this, {
				columns: [
					...
					Ext.create('Ext.grid.column.Column', {
						...
						editor: {
							...
							store: CMDBuild.proxy.common.field.filter.advanced.configurator.tabs.Relations.getStoreDestination(),
							queryMode: 'local'
						},
							...
							Ext.create('Ext.grid.column.CheckColumn', {
								...
								listeners: {
									...
									checkchange: function (column, rowIndex, checked, eOpts) {
										this.delegate.cmfg('onFieldFilterAdvancedConfiguratorConfigurationRelationsCheckchange', {
											checked: checked,
				...
				store: CMDBuild.proxy.common.field.filter.advanced.configurator.tabs.Relations.getStoreDomain(),
				plugins: [
					Ext.create('Ext.grid.plugin.CellEditing', {
						...
						listeners: {
							...
							beforeedit: function (editor, e, eOpts) {
								return this.delegate.cmfg('onFieldFilterAdvancedConfiguratorConfigurationRelationsGridDomainBeforeEdit', e);
							}
						}
					})
				]
		...
		listeners: {
			select: function (panel, record, index, eOpts) {
				this.delegate.cmfg('onFieldFilterAdvancedConfiguratorConfigurationRelationsDomainSelect', record);
			}
		}
	});
