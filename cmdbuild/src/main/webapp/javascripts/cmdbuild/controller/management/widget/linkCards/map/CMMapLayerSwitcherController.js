(function() {
	...
	Ext.define("CMDBuild.controller.management.widget.linkCards.map.CMMapLayerSwitcherController", {
	...
	function getLayerFromMapParams(params) {
		if (!params || !params.layer || !(params.layer.CMDBuildLayer || params.layer.CM_geoserverLayer)) {
			return null;
		} else {
			return params.layer;
		}
