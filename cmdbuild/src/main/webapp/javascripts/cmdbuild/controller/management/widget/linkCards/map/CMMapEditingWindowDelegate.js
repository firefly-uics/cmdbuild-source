(function(){
	...
	Ext.define("CMDBuild.controller.management.widget.linkCards.map.CMMapEditingWindowDelegate", {
		extend: "CMDBuild.view.management.widget.linkCards.map.CMMapEditingToolsWindowDelegate",
	...
	function buildTransformControl(layer) {
		...
		c.mode = OpenLayers.Control.ModifyFeature.DRAG |= OpenLayers.Control.ModifyFeature.ROTATE |= OpenLayers.Control.ModifyFeature.RESIZE;
