(function() {
	 ...
	 * CMMapController.
	 */
	Ext.define("CMDBuild.controller.management.widget.linkCards.map.CMCardBrowserDelegate", {
		extend: "CMDBuild.view.management.widget.linkCards.map.CMCardBrowserTreeDelegate",
