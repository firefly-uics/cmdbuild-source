(function() {
	...
	Ext.define("CMDBuild.controller.management.widget.linkCards.map.CMMapController", {
		...
		mixins: {
			...
			mapDelegate: "CMDBuild.view.management.widget.linkCards.map.CMMapPanelDelegate",
			editingWindowDelegate: "CMDBuild.controller.management.widget.linkCards.map.CMMapEditingWindowDelegate",
			layerSwitcherDelegate: "CMDBuild.view.management.widget.linkCards.map.CMMapLayerSwitcherDelegate",
			cardStateDelegate: "CMDBuild.state.CMCardModuleStateDelegate",
			miniCardGridDelegate: "CMDBuild.view.management.widget.linkCards.map.CMMiniCardGridDelegate"
		},
...
//				}
	...
	function buildLongPressController(me) {
		...
		var longPressControl = new OpenLayers.Control.LongPress({
			onLongPress: function(e) {
				...
				me.miniCardGridWindow = Ext.create('CMDBuild.view.management.widget.linkCards.map.CMMiniCardGridWindow', {
	...
	function addLayerForGeoAttribute(map, geoAttribute, me) {
		...
		addLayerToMap(map,
			CMDBuild.controller.management.widget.linkCards.map.LayerBuilder.buildLayer({
