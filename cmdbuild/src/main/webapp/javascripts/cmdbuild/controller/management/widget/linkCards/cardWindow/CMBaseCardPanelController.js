(function() {
	...
	Ext.define("CMDBuild.controller.management.widget.linkCards.cardWindow.CMBaseCardPanelController", {
		extend: "CMDBuild.controller.management.widget.linkCards.cardWindow.CMModCardSubController",
		...
		constructor: function(view, supercontroller, widgetControllerManager) {
			...
			if (widgetControllerManager) {
				...
				var widgetManager = Ext.create('CMDBuild.view.management.widget.linkCards.cardWindow.CMWidgetManager', {
					mainView: this.view
				});
				this.widgetControllerManager = Ext.create('CMDBuild.controller.management.widget.linkCards.cardWindow.CMWidgetManagerController', widgetManager);
			}
