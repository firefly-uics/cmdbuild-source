(function() {
	...
	Ext.define('CMDBuild.controller.management.widget.linkCards.cardWindow.CMCardWindowController', {
		extend: 'CMDBuild.controller.management.widget.linkCards.cardWindow.CMBaseCardPanelController',
