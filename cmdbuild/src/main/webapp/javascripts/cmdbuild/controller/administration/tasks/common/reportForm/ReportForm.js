(function () {
	...
	Ext.define('CMDBuild.controller.administration.tasks.common.reportForm.ReportForm', {
		...
		gridStoreFill: function (merge) {
			...
			Ext.Object.each(this.attributesGet(), function (name, attribute, myself) {
				if (Ext.isObject(attribute) && !Ext.Object.isEmpty(attribute)) {
					...
					records.push(Ext.create('CMDBuild.model.administration.taskManager.common.reportForm.Grid', attributeModelObject));
				}
			}, this);
		 ...
		 * @param {CMDBuild.model.administration.taskManager.common.reportForm.Grid} parameters.record
		 *
		 * @returns {Void}
		 */
		 ...
		 * @param {CMDBuild.model.administration.taskManager.common.reportForm.Report} parameters.record
		 *
		 * @returns {Void}
		 */
		onTaskManagerReportFormReportSelect: function (parameters) {
			...
			if (
				...
				CMDBuild.proxy.administration.taskManager.common.ReportForm.readParameters({
					params: params,
					scope: this,
