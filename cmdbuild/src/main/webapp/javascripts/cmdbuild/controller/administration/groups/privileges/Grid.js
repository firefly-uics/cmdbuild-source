(function() {
	...
	Ext.define('CMDBuild.controller.administration.groups.privileges.Grid', {
		...
		/**
		 * @property {CMDBuild.controller.administration.groups.privileges.UiConfiguration}
		 */
		...
		/**
		 * @cfg {CMDBuild.view.administration.groups.privileges.GridPanel}
		 */
		view: undefined,

		/**
		 * @param {Object} configurationObject
		 * @param {CMDBuild.controller.administration.groups.privileges.Privileges} configurationObject.parentDelegate
		 *
		 * @override
		 */
		constructor: function(configurationObject) {
			...
			this.controllerUiConfiguration = Ext.create('CMDBuild.controller.administration.groups.privileges.UiConfiguration', { parentDelegate: this });

			this.view = Ext.create('CMDBuild.view.administration.groups.privileges.GridPanel', {
				delegate: this,
				title: this.title,
