(function() {
	...
	Ext.define('CMDBuild.controller.administration.configuration.RelationGraph', {
		...
		cmOn: function(name, param, callBack) {
			switch (name) {
				case 'onRelationGraphAbortButtonClick':
					return this.onRelationGraphAbortButtonClick();

				case 'onRelationGraphSaveButtonClick':
					return this.onRelationGraphSaveButtonClick();
