...
//			'onAdvancedTableRowUpdateButtonClick'
		...
		/**
		 * @cfg {CMDBuild.view.administration.localizations.advancedTable.SectionProcessesPanel}
		 */
		view: undefined,
		...
		constructor: function(configObject) {
			...
			this.view = Ext.create('CMDBuild.view.administration.localizations.advancedTable.SectionProcessesPanel', {
				delegate: this
			});
