				...
				this.selectedDataStore.load({
					...
					callback: function(records, operation, success) {
						if (!Ext.isEmpty(records)) {
							...
							this.delegateStep[0].setValueWorkflowAttributesGrid(record.get(CMDBuild.core.proxy.Constants.WORKFLOW_ATTRIBUTES));
							this.delegateStep[0].setValueWorkflowCombo(record.get(CMDBuild.core.proxy.Constants.WORKFLOW_CLASS_NAME));
