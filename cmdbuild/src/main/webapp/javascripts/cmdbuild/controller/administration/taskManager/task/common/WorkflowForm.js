(function () {
	...
	Ext.define('CMDBuild.controller.administration.taskManager.task.common.WorkflowForm', {
		...
		/**
		 * @property {CMDBuild.view.administration.taskManager.task.common.workflowForm.Combobox}
		 */
		comboField: undefined,

		/**
		 * @property {CMDBuild.view.administration.taskManager.task.common.workflowForm.GridPanel}
		 */
		gridField: undefined,
		...
		/**
		 * @param {CMDBuild.view.administration.taskManager.task.common.workflowForm.WorkflowFormView} view
		 */
