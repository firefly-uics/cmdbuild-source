(function () {
	...
	Ext.define('CMDBuild.controller.administration.userAndGroup.group.tabs.UserInterface', {
		...
		cmfgCatchedFunctions: [
			...
			'onUserAndGroupGroupTabUserInterfaceGroupSelected = onUserAndGroupGroupTabGroupSelected',
		...
		/**
		 * @property {CMDBuild.view.administration.userAndGroup.group.tabs.userInterface.UserInterfaceView}
		 */
		view: undefined,
		...
		constructor: function (configurationObject) {
			...
			this.view = Ext.create('CMDBuild.view.administration.userAndGroup.group.tabs.userInterface.UserInterfaceView', { delegate: this });
			...
			CMDBuild.proxy.userAndGroup.group.Group.read({
				...
				success: function (response, options, decodedResponse) {
					...
					if (Ext.isArray(decodedResponse) && !Ext.isEmpty(decodedResponse)) {
						...
						if (Ext.isObject(loggedUserCurrentGroup) && !Ext.Object.isEmpty(loggedUserCurrentGroup))
