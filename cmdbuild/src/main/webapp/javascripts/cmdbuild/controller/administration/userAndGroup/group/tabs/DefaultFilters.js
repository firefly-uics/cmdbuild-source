(function () {
	...
	Ext.define('CMDBuild.controller.administration.userAndGroup.group.tabs.DefaultFilters', {
		...
		cmfgCatchedFunctions: [
			...
			'onUserAndGroupGroupTabDefaultFiltersGroupSelected = onUserAndGroupGroupTabGroupSelected',
		...
		/**
		 * @property {CMDBuild.view.administration.userAndGroup.group.tabs.defaultFilters.TreePanel}
		 */
		tree: undefined,

		/**
		 * @property {CMDBuild.view.administration.userAndGroup.group.tabs.defaultFilters.DefaultFiltersView}
		 */
		view: undefined,
		...
		constructor: function (configurationObject) {
			...
			this.view = Ext.create('CMDBuild.view.administration.userAndGroup.group.tabs.defaultFilters.DefaultFiltersView', { delegate: this });
		...
		filtersBufferBuild: function () {
			CMDBuild.proxy.userAndGroup.group.tabs.DefaultFilters.readAllGroupFilters({
				loadMask: false,
				scope: this,
