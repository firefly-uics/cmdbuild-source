(function () {
	...
	Ext.define('CMDBuild.controller.administration.userAndGroup.group.privileges.tabs.Filter', {
		...
		/**
		 * @cfg {CMDBuild.view.administration.userAndGroup.group.privileges.tabs.Filter}
		 */
		view: undefined,
		...
		constructor: function (configurationObject) {
			...
			this.view = Ext.create('CMDBuild.view.administration.userAndGroup.group.privileges.tabs.Filter', { delegate: this });
		},
		...
		onUserAndGroupGroupTabPrivilegesTabFilterSetPrivilege: function (parameters) {
			if (!Ext.isEmpty(parameters) && Ext.isObject(parameters)) {
				...
				CMDBuild.core.proxy.userAndGroup.group.privileges.Filter.update({
					params: params,
					scope: this,
