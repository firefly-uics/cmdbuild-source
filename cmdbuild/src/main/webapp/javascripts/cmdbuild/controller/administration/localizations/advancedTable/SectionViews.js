...
//			'onAdvancedTableRowUpdateButtonClick'
		...
		/**
		 * @cfg {CMDBuild.view.administration.localizations.advancedTable.SectionViewsPanel}
		 */
		view: undefined,
		...
		constructor: function(configObject) {
			...
			this.view = Ext.create('CMDBuild.view.administration.localizations.advancedTable.SectionViewsPanel', {
				delegate: this
			});
