...
//			'onAdvancedTableRowUpdateButtonClick'
		...
		/**
		 * @cfg {CMDBuild.view.administration.localizations.advancedTable.SectionLookupPanel}
		 */
		view: undefined,
		...
		constructor: function(configObject) {
			...
			this.view = Ext.create('CMDBuild.view.administration.localizations.advancedTable.SectionLookupPanel', {
				delegate: this
			});
