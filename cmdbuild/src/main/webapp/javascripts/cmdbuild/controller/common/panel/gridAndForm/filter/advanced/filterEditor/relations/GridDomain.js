(function () {
	...
	Ext.define('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.GridDomain', {
				...
				CMDBuild.proxy.common.panel.gridAndForm.filter.advanced.filterEditor.Relations.readAllEntryTypes({
					...
					success: function (response, options, decodedResponse) {
						...
						if (!Ext.isEmpty(decodedResponse) && Ext.isArray(decodedResponse)) {
							...
							var anchestorsId = CMDBuild.core.Utils.getEntryTypeAncestorsId(this.cmfg('panelGridAndFormFilterAdvancedEntryTypeGet'));
