(function () {
	...
	Ext.define('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.Manager', {
		...
		/**
		 * @property {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.FilterEditor}
		 */
		controllerFilterEditor: undefined,

		/**
		 * @property {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.SaveDialog}
		 */
		 ...
		 * @param {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.Advanced} configurationObject.parentDelegate
		 *
		 * @returns {Void}
		 *
		 * @override
		...
		constructor: function (configurationObject) {
			...
			this.controllerFilterEditor = Ext.create('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.FilterEditor', { parentDelegate: this });
			this.controllerSaveDialog = Ext.create('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.SaveDialog', { parentDelegate: this});
