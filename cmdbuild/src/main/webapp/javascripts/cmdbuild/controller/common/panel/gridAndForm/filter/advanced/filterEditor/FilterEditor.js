(function () {
	 ...
	 */
	Ext.define('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.FilterEditor', {
		...
		/**
		 * @property {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.Attributes}
		 */
		controllerAttributes: undefined,

		/**
		 * @property {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.Relations}
		 */
		 ...
		 * @param {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.Manager} configurationObject.parentDelegate
		 *
		 * @returns {Void}
		 *
		 * @override
		...
		constructor: function (configurationObject) {
			...
			this.controllerAttributes = Ext.create('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.Attributes', { parentDelegate: this });
			this.controllerRelations = Ext.create('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.Relations', { parentDelegate: this });
