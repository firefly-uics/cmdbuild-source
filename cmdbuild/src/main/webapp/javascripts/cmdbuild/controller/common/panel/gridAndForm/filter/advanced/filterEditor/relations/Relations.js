(function () {
	...
	Ext.define('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.Relations', {
		extend: 'CMDBuild.controller.common.abstract.Base',

		requires: ['CMDBuild.core.constants.Proxy'],

		/**
		 * @cfg {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.FilterEditor}
		 */
		...
		/**
		 * @property {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.GridDomain}
		 */
		controllerGridDomain: undefined,

		/**
		 * @property {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.GridCard}
		 */
		 ...
		 * @param {CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.FilterEditor} configurationObject.parentDelegate
		 *
		 * @returns {Void}
		 *
		 * @override
		...
		constructor: function (configurationObject) {
			...
			// Sub-controllers
			this.controllerGridCard = Ext.create('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.GridCard', { parentDelegate: this });
			this.controllerGridDomain = Ext.create('CMDBuild.controller.common.panel.gridAndForm.filter.advanced.filterEditor.relations.GridDomain', { parentDelegate: this });
