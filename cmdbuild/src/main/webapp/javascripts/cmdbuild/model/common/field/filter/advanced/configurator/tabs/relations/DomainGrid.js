(function () {
	...
	Ext.define('CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.DomainGrid', { // TODO: waiting for refactor (rename)
		...
		fields: [
			...
			{ name: CMDBuild.core.constants.Proxy.DESTINATION, type: 'auto' }, // {CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.EntryType}
			...
			{ name: CMDBuild.core.constants.Proxy.DOMAIN, type: 'auto' }, // {CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.Domain}
			...
			{ name: CMDBuild.core.constants.Proxy.SOURCE, type: 'auto' } // {CMDBuild.model.common.field.filter.advanced.configurator.tabs.relations.EntryType}
		],
