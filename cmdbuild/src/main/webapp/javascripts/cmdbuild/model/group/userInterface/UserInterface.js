	...
	Ext.define('CMDBuild.model.group.userInterface.UserInterface', {
		...
		constructor: function(data) {
			...
			if (Ext.isArray(data[CMDBuild.core.constants.Proxy.DISABLED_CARD_TABS])) {
				...
				this.set(CMDBuild.core.constants.Proxy.DISABLED_CARD_TABS, Ext.create('CMDBuild.model.group.userInterface.DisabledCardTabs', modelObject));
			} else {
				this.set(CMDBuild.core.constants.Proxy.DISABLED_CARD_TABS, Ext.create('CMDBuild.model.group.userInterface.DisabledCardTabs', data));
			}
			...
			if (Ext.isArray(data[CMDBuild.core.constants.Proxy.DISABLED_MODULES])) {
				...
				this.set(CMDBuild.core.constants.Proxy.DISABLED_MODULES, Ext.create('CMDBuild.model.group.userInterface.DisabledModules', modelObject));
			} else {
				this.set(CMDBuild.core.constants.Proxy.DISABLED_MODULES, Ext.create('CMDBuild.model.group.userInterface.DisabledModules', data));
			}
			...
			if (Ext.isArray(data[CMDBuild.core.constants.Proxy.DISABLED_PROCESS_TABS])) {
				...
				this.set(CMDBuild.core.constants.Proxy.DISABLED_PROCESS_TABS, Ext.create('CMDBuild.model.group.userInterface.DisabledProcessTabs', modelObject));
			} else {
				this.set(CMDBuild.core.constants.Proxy.DISABLED_PROCESS_TABS, Ext.create('CMDBuild.model.group.userInterface.DisabledProcessTabs', data));
			}
		},
