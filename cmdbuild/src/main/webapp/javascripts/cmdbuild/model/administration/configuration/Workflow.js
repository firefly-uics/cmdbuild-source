(function () {
	 ...
	 */
	Ext.define('CMDBuild.model.administration.configuration.Workflow', {
		...
		constructor: function (data) {
			...
			data[CMDBuild.core.constants.Proxy.URL] = data[CMDBuild.core.constants.Proxy.URL] || data['endpoint'];
