(function() {
	...
	Ext.define('CMDBuild.model.groups.userInterface.UserInterface', {
		...
		constructor: function(data) {
			...
			if (Ext.isArray(data[CMDBuild.core.proxy.CMProxyConstants.DISABLED_CARD_TABS])) {
				...
				this.set(CMDBuild.core.proxy.CMProxyConstants.DISABLED_CARD_TABS, Ext.create('CMDBuild.model.groups.userInterface.DisabledCardTabs', modelObject));
			} else {
				this.set(CMDBuild.core.proxy.CMProxyConstants.DISABLED_CARD_TABS, Ext.create('CMDBuild.model.groups.userInterface.DisabledCardTabs', data));
			}
			...
			if (Ext.isArray(data[CMDBuild.core.proxy.CMProxyConstants.DISABLED_MODULES])) {
				...
				this.set(CMDBuild.core.proxy.CMProxyConstants.DISABLED_MODULES, Ext.create('CMDBuild.model.groups.userInterface.DisabledModules', modelObject));
			} else {
				this.set(CMDBuild.core.proxy.CMProxyConstants.DISABLED_MODULES, Ext.create('CMDBuild.model.groups.userInterface.DisabledModules', data));
			}
			...
			if (Ext.isArray(data[CMDBuild.core.proxy.CMProxyConstants.DISABLED_PROCESS_TABS])) {
				...
				this.set(CMDBuild.core.proxy.CMProxyConstants.DISABLED_PROCESS_TABS, Ext.create('CMDBuild.model.groups.userInterface.DisabledProcessTabs', modelObject));
			} else {
				this.set(CMDBuild.core.proxy.CMProxyConstants.DISABLED_PROCESS_TABS, Ext.create('CMDBuild.model.groups.userInterface.DisabledProcessTabs', data));
			}
		},
