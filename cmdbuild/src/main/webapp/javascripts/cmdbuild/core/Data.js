	...
	Ext.define('CMDBuild.core.Data', {
		...
		constructor: function (configurationObject) {
			...
			if (!Ext.isEmpty(CMDBuild)) {
				var defaultHeaders = {};
				defaultHeaders[CMDBuild.core.constants.Proxy.AUTHORIZATION_HEADER_KEY] = Ext.util.Cookies.get(CMDBuild.core.constants.Proxy.AUTHORIZATION_HEADER_KEY);
				...
				Ext.Ajax[CMDBuild.core.constants.Proxy.AUTHORIZATION_HEADER_KEY] = Ext.util.Cookies.get(CMDBuild.core.constants.Proxy.AUTHORIZATION_HEADER_KEY);
