(function() {
	...
	Ext.define('CMDBuild.core.proxy.configuration.Bim', {
		...
		requires: [
			...
			'CMDBuild.core.configurationBuilders.Bim',
		...
		read: function(parameters) {
			...
			parameters.success = Ext.Function.createInterceptor(parameters.success, function(response, options, decodedResponse) {
				if (!CMDBuild.core.configurationBuilders.Bim.isValid())
					CMDBuild.core.configurationBuilders.Bim.build(decodedResponse); // Refresh CMDBuild configuration object
			}, this);
		...
		update: function(parameters) {
			...
			CMDBuild.core.configurationBuilders.Bim.invalid(); // Invalidate CMDBuild configuration object
