(function () {
	...
	Ext.define('CMDBuild.core.proxy.classes.tabs.History', {
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.HISTORY, {
				...
				proxy: {
					type: 'ajax',
					url: CMDBuild.core.proxy.index.Json.history.classes.card.read,
					reader: {
						type: 'json',
		...
		readHistoric: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.history.classes.card.readHistoric });
		...
		readHistoricRelation: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.history.classes.card.readHistoricRelation });
		...
		readRelations: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.history.classes.card.readRelations });
