(function () {
	...
	Ext.define('CMDBuild.core.proxy.common.tabs.attribute.Order', {
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.ATTRIBUTE, {
				...
				proxy: {
					type: 'ajax',
					url: CMDBuild.core.proxy.index.Json.attribute.readAll,
					reader: {
						type: 'json',
		...
		reorder: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.attribute.sorting.reorder });
		...
		update: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.attribute.sorting.update });
