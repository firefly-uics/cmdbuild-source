(function () {
	...
	Ext.define('CMDBuild.core.proxy.Menu', {
		...
		read: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.menu.read });
		...
		readAvailableItems: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.menu.readAvailableItems });
		...
		readConfiguration: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.menu.readConfiguration });
		...
		remove: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.menu.remove });
		...
		save: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.menu.update });
