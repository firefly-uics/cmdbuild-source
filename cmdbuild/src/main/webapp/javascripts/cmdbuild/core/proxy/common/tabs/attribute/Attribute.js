(function () {
	 ...
	 */
	Ext.define('CMDBuild.core.proxy.common.tabs.attribute.Attribute', {
		...
		getStoreTypes: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.ATTRIBUTE, {
				...
				proxy: {
					type: 'ajax',
					url: CMDBuild.core.proxy.index.Json.attribute.readTypes,
					reader: {
						type: 'json',
		...
		getStoreRenceableDomains: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.DOMAIN, {
				...
				proxy: {
					type: 'ajax',
					url: CMDBuild.core.proxy.index.Json.attribute.readRenceableDomains,
					reader: {
						type: 'json',
