(function () {
	...
	Ext.define('CMDBuild.core.proxy.workflow.Activity', {
		...
		abort: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.workflow.activity.abort });
		...
		read: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.workflow.activity.read });
		...
		update: function (parameters) {
			...
			Ext.apply(parameters, { url: CMDBuild.core.proxy.index.Json.workflow.activity.update });
