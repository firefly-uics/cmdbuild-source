(function() {
	...
	Ext.define('Ext.ux.form.MultiSelect', {
		...
		markInvalid: function(errors) {
			...
			me.boundList.addCls('cm-form-invalid-field');
		},

		/**
		 * Clear any invalid styles/messages for this field.
		 *
		 * **Note**: this method does not cause the Field's {@link #validate} or {@link #isValid} methods to return `true` if the
		 * value does not _pass_ validation. So simply clearing a field's errors will not necessarily allow submission of forms
		...
		clearInvalid: function() {
			...
			me.boundList.removeCls('cm-form-invalid-field');
		},
