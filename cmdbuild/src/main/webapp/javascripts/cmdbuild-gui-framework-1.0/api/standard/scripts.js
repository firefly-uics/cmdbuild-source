	...
	var scripts = {
		...
		htmlText: function(param) {
			tinymce.init({
				...
				theme_modern_buttons1: 'bold,italic,underline,|,fontsizeselect,|,forecolor,backcolor,|,justifyleft,justifycenter,justifyright,justifyfull,|,link,unlink,|,bullist,numlist,|,pastetext,pasteword,|,cleanup,removeformat,|,fullscreen,|,code',
		...
		date: function(param) {
			try {
				$('#' + param.id).datepicker({ dateFormat: "dd/mm/yy" });
			}
			catch (e) {
				if (e.message != $.Cmdbuild.errorsManager.CMERROR) {
