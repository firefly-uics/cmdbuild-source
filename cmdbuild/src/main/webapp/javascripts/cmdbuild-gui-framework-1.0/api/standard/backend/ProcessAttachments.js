(function($) {
	...
	var ProcessAttachments = function(param, onReadyFunction, onReadyScope) {
		/**
		 * Attributes
		 */
		this.param = param;
		...
		this.loadData = function(param, callback, callbackScope) {
			...
			$.Cmdbuild.utilities.proxy.getInstanceAttachment(this.type, this.procId, config,
	...
	$.Cmdbuild.standard.backend.ProcessAttachments = ProcessAttachments;
}) (jQuery);