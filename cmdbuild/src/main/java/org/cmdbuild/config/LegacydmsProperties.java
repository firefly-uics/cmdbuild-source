...
/**
 * @deprecated replace with a non-legacy one
 */
public class LegacydmsProperties extends DefaultProperties {

	private static final long serialVersionUID = 1L;

	private static final String MODULE_NAME = "legacydms";
	...
	public static LegacydmsProperties getInstance() {
		return (LegacydmsProperties) Settings.getInstance().getModule(MODULE_NAME);
	}
