...
public interface Private {
	...
	public CardList getCardHistory(
			@WebParam(name = "className") String className,
	...
	public Lookup[] getLookupList(
			@WebParam(name = "type") String type, 
			@WebParam(name = "value") String value, 
			@WebParam(name = "parentList") boolean parentList);
	
	public Lookup[] getLookupListByCode(
			@WebParam(name = "type") String type, 
	...
	public ActivitySchema getActivityObjects(
			@WebParam(name = "className") String className, 
			@WebParam(name = "cardid") Integer cardid);
	...
	public Reference[] getReference(
			@WebParam(name = "className") String className, 
			@WebParam(name = "query") Query query, 
			@WebParam(name = "orderType") Order[] orderType, 
			@WebParam(name = "limit") Integer limit, 
			@WebParam(name = "offset") Integer offset, 
			@WebParam(name = "fullTextQuery") String fullTextQuery);
	...
	public AttributeSchema[] getReportParameters(
