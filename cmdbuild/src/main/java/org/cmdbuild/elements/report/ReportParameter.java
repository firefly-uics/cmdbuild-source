 ...
 * - All custom parameters are required; set a property with name="required" and value="false" to override
 *
 */
...
public abstract class ReportParameter {
	...
	protected static final String regExpLR = "[\\w\\s]*\\.\\w*\\.[\\w\\s]*"; // regular expression matching lookup and reference parameters format
