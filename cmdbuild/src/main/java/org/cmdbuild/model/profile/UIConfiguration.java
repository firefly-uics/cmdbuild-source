...
public class UIConfiguration {
	 ...
	 * @param disabledModules the modules to disable
	 */
	 ...
	 * @param disabledCardTabs the tabs to disable
	 */
	public void setDisabledCardTabs(String[] disabledCardTabs) {
	 ...
	 * @param disabledProcessTabs the tabs to disable
	 */
	public void setDisabledProcessTabs(String[] disabledProcessTabs) {
	...
	/**
	 * the simple mode for the history panel shows only start/end date and the user
	 ...
	 */
	public void setSimpleHistoryModeForCard(boolean simpleHistoryModeForCard) {
	 ...
	 */
	public void setSimpleHistoryModeForProcess(boolean simpleHistoryModeForProcess) {
		this.simpleHistoryModeForProcess = simpleHistoryModeForProcess;
	}

	/**
	 * 
	 * @return if the widget of the process module must be always enabled,
	 * also when the activity is not in editing mode
	 */
	...
	/**
	 * set if the widget of the process must be enabled also when the activity is
	 * not in editing mode
