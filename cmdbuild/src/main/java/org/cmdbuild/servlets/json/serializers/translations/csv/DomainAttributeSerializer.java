...
public class DomainAttributeSerializer extends DefaultElementSerializer {
	...
	public Collection<? extends CsvTranslationRecord> serialize() {
		...
		final String domainName = theAttribute.getOwner().getName();
		final TranslatableElement element = TranslatableElement.ATTRIBUTEDOMAIN;
		return serializeFields(domainName, attributeName, element);
	}

	public static class Builder implements org.apache.commons.lang3.builder.Builder<DomainAttributeSerializer> {
		...
		@Override
		public DomainAttributeSerializer build() {
			return new DomainAttributeSerializer(this);
		}
	...
	private DomainAttributeSerializer(final Builder builder) {
