...
public class BimLayerSerializer {
	...
	public static JSONArray toClient(final List<BimLayer> layerList)  throws JSONException {
	...
	public static JSONObject toClient(final BimLayer layer)  throws JSONException {
