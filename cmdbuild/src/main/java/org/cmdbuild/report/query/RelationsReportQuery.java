...
public class RelationsReportQuery {
	...
	public RelationsReportQuery(Card card, Iterable<? extends CMDomain> domains) {
	...
	private String buildInverseSubSelect(Card card, CMDomain domain) {
	...
	private String buildDirectSubSelect(Card card, CMDomain domain) {
		final StringBuilder query = new StringBuilder();
		final String domainName = domain.getIdentifier().getLocalName();
