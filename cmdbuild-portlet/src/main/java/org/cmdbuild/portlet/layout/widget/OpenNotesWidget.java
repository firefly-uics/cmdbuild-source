...
public class OpenNotesWidget extends WorkflowWidget {
	...
	public OpenNotesWidget(final WorkflowWidgetDefinition definition) {
		super(definition);
	}
	...
	public String generateHtml(final HttpServletRequest request) {
		...
		layout
				.append("<input id=\"CMDBuildSaveeditor\" type=\"button\" value=\"Conferma\" onclick=\"CMDBuildSaveNote();\"/>");
		layout.append("</div>");
		layout.append("</div>");
