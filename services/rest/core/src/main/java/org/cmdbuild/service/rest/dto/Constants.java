...
public class Constants {
	...
	public static final String NEW_CARD_RESPONSE = "newCardResponse";
	...
	public static final String TYPE_ENTRY_TYPE = "entryType";
	public static final String TYPE_FOREIGN_KEY = "foreignKey";
