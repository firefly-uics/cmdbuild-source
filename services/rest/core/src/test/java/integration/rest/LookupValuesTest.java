...
public class LookupValuesTest {
	...
	public void getLookups() throws Exception {
		// given
		final ResponseMultiple<LookupDetail> expectedResponse = Builders.<LookupDetail> newResponseMultiple() //
				.withElements(asList( //
						newLookupDetail() //
								.withId(123L) //
								.withCode("foo") //
	...
	public void getLookup() throws Exception {
		// given
		final ResponseSingle<LookupDetail> expectedResponse = Builders.<LookupDetail> newResponseSingle() //
