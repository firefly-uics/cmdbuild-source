...
import static org.cmdbuild.service.rest.model.Models.newClassPrivilege;
...
import org.cmdbuild.service.rest.model.ClassPrivilege;
...
public class ClassPrivilegesTest {
	...
	public ServerResource server = ServerResource.newInstance() //
			.withServiceClass(ClassPrivileges.class) //
			.withService(service = mock(ClassPrivileges.class)) //
			.withPort(randomPort()) //
			.build();
