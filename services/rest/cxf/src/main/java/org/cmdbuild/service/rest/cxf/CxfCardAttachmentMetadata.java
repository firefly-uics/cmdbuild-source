...
public class CxfCardAttachmentMetadata implements CardAttachmentMetadata {
	...
	public CxfCardAttachmentMetadata(final ErrorHandler errorHandler, final DmsLogic dmsLogic,
