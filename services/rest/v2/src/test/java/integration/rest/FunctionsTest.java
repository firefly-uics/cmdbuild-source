...
public class FunctionsTest {
	...
	public void functionsRetrieved() throws Exception {
		// given
		final ResponseMultiple<Function> expectedResponse = newResponseMultiple(Function.class) //
				.withElements(asList( //
						newFunction() //
								.withId(1L) //
								.withName("foo") //
				...
				.withMetadata(newMetadata() //
						...
						.build()) //
				.build();
		when(service.readAll(anyInt(), anyInt(), anyString(), anyBoolean())) //
		...
		verify(service).readAll(eq(123), eq(456), eq("this is the filter"), eq(true));
	}

	@Test
	public void functionDetailsRetrieved() throws Exception {
		// given
		final ResponseSingle<Function> expectedResponse = newResponseSingle(Function.class) //
				.withElement(newFunction() //
						.withId(1L) //
						.withName("foo") //
						.withDescription("Foo") //
						.withMetadata(ChainablePutMap.of(new HashMap<String, Object>()) //
