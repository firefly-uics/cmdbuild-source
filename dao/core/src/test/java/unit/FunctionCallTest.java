...
public class FunctionCallTest {
	...
	public void actualParametersMustMatchTheFunctionSignature() {
		CMFunction function = mock(CMFunction.class);
		List<CMFunctionParameter> inputParams = mock(List.class);
	...
	public void parametersCanBeSpecifiedAsAnArray() {
		...
		FunctionCall fc = call(function, "v1", 2);
	...
	public void parametersCanBeSpecifiedAsAMap() {
		...
		FunctionCall fc = call(function, new HashMap<String, Object>() {{
