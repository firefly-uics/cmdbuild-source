...
public abstract class ForwardingDataView extends ForwardingObject implements CMDataView {

	/**
	 * Usable by subclasses only.
	 */
	protected ForwardingDataView() {
	}

	@Override
	protected abstract CMDataView delegate();
