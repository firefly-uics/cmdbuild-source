...
public class CMDBfId extends MdrScopedIdType {
	...
	public CMDBfId(MdrScopedIdType id) {
		this(id.getMdrId(), id.getLocalId());
	}
	
	public CMDBfId(String mdrId, String localId) {
		setMdrId(mdrId);
		setLocalId(localId); 
	}
	...
	public static String toString(MdrScopedIdType id) {
	...
	public static CMDBfId valueOf(String value) {
		Matcher matcher = pattern.matcher(value);
		if(matcher.find()) {
			String mdrId = matcher.group(1);
