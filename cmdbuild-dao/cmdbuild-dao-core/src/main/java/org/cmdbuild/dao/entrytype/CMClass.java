...
public interface CMClass extends CMEntryType {
	...
	/**
	 * The code attribute is supposed to be unique for the class and it
	 * should be human-readable. It is used to identify cards in the CSV
	 * import and wherever a numeric key is not practical.
	 * 
