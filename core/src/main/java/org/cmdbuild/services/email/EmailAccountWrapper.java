...
public class EmailAccountWrapper implements EmailConfiguration {

	public static EmailAccountWrapper of(final EmailAccount emailAccount) {
		return new EmailAccountWrapper(emailAccount);
	}

	private final EmailAccount emailAccount;

	private EmailAccountWrapper(final EmailAccount emailAccount) {
