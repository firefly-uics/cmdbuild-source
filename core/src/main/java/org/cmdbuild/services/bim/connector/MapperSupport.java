...
class MapperSupport {
	...
	public MapperSupport(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate;
	}

	public static CMCard fetchCardWithKey(String key, String className,
			CMDataView dataView) {
	...
	public static String findReferencedClassNameFromReferenceAttribute(
	...
	public static Long findIdFromKey(String value, String className,
			CMDataView dataView) {
	...
	public static Long findLookupIdFromDescription(String lookupValue,
