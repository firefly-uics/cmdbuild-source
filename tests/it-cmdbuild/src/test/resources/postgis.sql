...
--	RETURNS float8
--	AS '$libdir/postgis-2.0', 'geometry_gist_selectivity_nd'
--	LANGUAGE 'c';

-- Availability: 2.0.0
--CREATE OR REPLACE FUNCTION geography_gist_join_selectivity_nd(internal, oid, internal, smallint)
--	RETURNS float8
--	AS '$libdir/postgis-2.0', 'geometry_gist_join_selectivity_nd'
--	LANGUAGE 'c';
...
CREATE OR REPLACE FUNCTION postgis_scripts_build_date() RETURNS text
	AS 'SELECT ''2013-07-22 07:00:47''::text AS version'
	LANGUAGE 'sql' IMMUTABLE;
