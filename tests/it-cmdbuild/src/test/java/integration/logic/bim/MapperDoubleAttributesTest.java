...
public class MapperDoubleAttributesTest extends IntegrationTestBase {
	...
	public void createCardWithDoubleAttribute() throws Exception {
		...
		assertThat(card.get(ATTRIBUTE_NAME).toString(), equalTo("10.5"));
	}
	...
	public void updateCardWithDoubleAttribute() throws Exception {
		...
		assertThat(card.getDescription().toString(), equalTo("Edificio 1"));
		assertThat(card.getCode().toString(), equalTo("E1"));
		assertThat(card.get(ATTRIBUTE_NAME).toString(), equalTo("9.35"));
	}
